...
import util.extend.map.FileMap;
...
public class FreemarkerUtil {
     ...
     */
    public void fprint(String name, Map<String, ?> root) throws TemplateException, IOException {
     ...
     * @throws TemplateException 
     */
    public void fprint(String name, Map<String,?> root, String outFile) throws IOException, TemplateException {
        FileWriter out = null;
        try {
     ...
     * @throws TemplateException 
     */
    public void fprint(String name,  String outFile,String...strings) throws IOException, TemplateException {
